...
%sets up epsilon matrix
epi{1} = ones(nx{1},ny{1})*c_eps_0;

%this is the code that creates an inclusion.
epi{1}(125:150,55:95)= c_eps_0*11.3; %when this is commented out, the wave passes through.

%adding more inclusions:
epi{1} (125:150,50:60) = c_eps_0*11.3;
epi{1} (125:150,85:93) = c_eps_0*11.3;
epi{1} (125:150,77:84) = c_eps_0*11.3;
...
%this sets up the type of boundary
%xm, xp, ym, yp = different boundary sides
%a = absorption boundary type, e = electric field generation type
bc{1}.xm.type = 'a';
bc{1}.xp.type = 'e';
bc{1}.ym.type = 'a';
bc{1}.yp.type = 'a';
